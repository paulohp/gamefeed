...
class CompetitorsControllerTest < ActionController::TestCase
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post :create, competitor: { bio: @competitor.bio, city: @competitor.city, email: @competitor.email, name: @competitor.name, username: @competitor.username }
    end
  ...
  test "should update competitor" do
    patch :update, id: @competitor, competitor: { bio: @competitor.bio, city: @competitor.city, email: @competitor.email, name: @competitor.name, username: @competitor.username }
    assert_redirected_to competitor_path(assigns(:competitor))
  end
