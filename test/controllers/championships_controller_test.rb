...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { date: @championship.date, description: @championship.description, game: @championship.game, name: @championship.name, number_competitors: @championship.number_competitors }
    end
  ...
  test "should update championship" do
    patch :update, id: @championship, championship: { date: @championship.date, description: @championship.description, game: @championship.game, name: @championship.name, number_competitors: @championship.number_competitors }
    assert_redirected_to championship_path(assigns(:championship))
  end
